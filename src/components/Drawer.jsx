    ...
    <div style={{ display: 'none' }} className="overlay">
      <div className="drawer d-flex flex-column">
        <h2 className='d-flex justify-between mb-30'>
          Корзина <img className='remove-btn' src="./src/assets/img/btn-remove.svg" alt="remove" />
        </h2>
        <ul className='list d-flex flex-column'>
          <li className="cart__item d-flex align-center">
            ...
            <img className='remove-btn' src="./src/assets/img/btn-remove.svg" alt="remove" />
          </li>
          <li className="cart__item d-flex align-center">
